    ...
    model_list_of_normalised_data = [
        {
            ...
            'sys_ts_micro': 86210,
            'bid': Decimal('78388.0000000'),
            'ask': Decimal('78388.5000000'),
            'bid_quantity': Decimal('14410.0000000'),
            'ask_quantity': Decimal('36580.0000000'),
            'high': Decimal('79561.5000000'),
            'low': Decimal('77859.0000000'),
            'price_change': Decimal('-0.8092000'),
            'volume': Decimal('5737.7872331'),
            'volume_usd': Decimal('452609800.0000000'),
            'volume_notional': Decimal('452609800.0000000'),
            'index_price': Decimal('78358.6200000'),
            'last_price': Decimal('78389.0000000'),
            'settlement_price': Decimal('78928.8500000'),
            'min_price': Decimal('77210.0000000'),
            'max_price': Decimal('79562.0000000'),
            'open_interest': 908588760,
            'mark_price': Decimal('78385.9000000'),
            'interest_value': Decimal('0.0097442'),
            'current_funding': Decimal('0.0000981'),
            'estimated_delivery_price': Decimal('78358.6200000'),
            'funding_8h': Decimal('0.0000493')
        },{
            'channel': 'ticker.BTC-PERPETUAL.raw',
            'exch_ts_sec': 1787738639,
            'exch_ts_micro': 996999,
